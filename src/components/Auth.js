...
class Auth extends Component {
    ...
    register = (e) => {
        ...
        const profilePic = `https://robohash.org/${random}.png?size=150x150`

        const { username, password } = this.state

        axios.post('/api/auth/register', { username, password, profilePic })
            .then(res => {
                ...
                <div className='auth-box'>
                    ...
                    <form className='auth-form'>
                        ...
                        <div className='form-buttons'>
                            <button id='register' type='submit' onClick={this.register}>Register</button>
